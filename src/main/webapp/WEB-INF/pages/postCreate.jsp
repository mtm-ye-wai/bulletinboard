...
<link rel="stylesheet" href="/bulletinboard/resources/assets/css/bootstrap.min.css" />
			...
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						...
						<div class="card-body">
							<form:form class="py-5" method="POST" action="${confirm ? '/bulletinboard/posts/store' : '/bulletinboard/posts/create/confirm' }" modelAttribute="postForm">
								<div class="row mb-3">
									<div class="col-4 text-end">
										<label for="postTitle" class="form-label text-end required">Title</label>									
									</div>
									<div class="col-6">
								...
								<div class="row mb-3">
									<div class="col-4 text-end">
										<label for="postDesc" class="form-label text-end required">Description</label>									
									</div>
									<div class="col-6">
